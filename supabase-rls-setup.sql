-- =====================================================
-- RLS POLICIES SETUP FOR VILLAGE WEBSITE
-- =====================================================
...
ALTER TABLE public.anggaran_desa ENABLE ROW LEVEL SECURITY;
...
-- =====================================================
-- ANGGARAN_DESA TABLE POLICIES
-- =====================================================

DROP POLICY IF EXISTS "Public can read anggaran" ON public.anggaran_desa;
DROP POLICY IF EXISTS "Admin can insert anggaran" ON public.anggaran_desa;
DROP POLICY IF EXISTS "Admin can update anggaran" ON public.anggaran_desa;
DROP POLICY IF EXISTS "Admin can delete anggaran" ON public.anggaran_desa;

CREATE POLICY "Public can read anggaran" ON public.anggaran_desa
FOR SELECT TO anon, authenticated
USING (true);

CREATE POLICY "Admin can insert anggaran" ON public.anggaran_desa
FOR INSERT TO authenticated
WITH CHECK (
  EXISTS (
    SELECT 1 FROM public.user_roles 
...
CREATE POLICY "Admin can update anggaran" ON public.anggaran_desa
FOR UPDATE TO authenticated
USING (
  EXISTS (
    SELECT 1 FROM public.user_roles 
...
CREATE POLICY "Admin can delete anggaran" ON public.anggaran_desa
FOR DELETE TO authenticated
USING (
  EXISTS (
    SELECT 1 FROM public.user_roles 

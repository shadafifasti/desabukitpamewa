...
export default function Perdes() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const filePath = `perdes/${fileName}`;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Peraturan Desa (Perdes)</h1>
          <p className="text-gray-600">
            Kumpulan dokumen Peraturan Desa yang berlaku di Desa Bukit Pamewa
          </p>
        </div>
          ...
          <div className="mb-6">
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  <DialogTitle>Upload Peraturan Desa</DialogTitle>
                  <DialogDescription>
                    Upload dokumen PDF Peraturan Desa baru
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <Label htmlFor="judul">Judul Peraturan Desa *</Label>
                    <Input
                      id="judul"
                      value={formData.judul}
                      onChange={(e) => setFormData(prev => ({ ...prev, judul: e.target.value }))}
                      placeholder="Contoh: Perdes No. 1 Tahun 2024 tentang..."
                      required
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Deskripsi singkat tentang peraturan desa ini..."
                      rows={3}
                    />
                  </div>
                  <div>
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                Belum ada dokumen Peraturan Desa
              </h3>
              <p className="text-gray-500">
                {user ? 'Klik tombol "Upload Perdes" untuk menambahkan dokumen pertama' : 'Dokumen akan ditampilkan di sini setelah diunggah oleh admin'}
              </p>
            </CardContent>
          </Card>
        ) : (
